...
function App() {
  ...
  return (
    ...
    <div className="bg-red-400 min-h-screen text-slate-800 p-4 sm:p-8">
      <header className="text-center mb-12">
        <h1 className="text-4xl font-bold text-slate-700">MERN Stack Activity Heatmap</h1>
      </header>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <CalendarHeatmap
                ...
                classForValue={(value) => {
                    ...
                    return 'color-scale-1'; // For count of 1
                }}
